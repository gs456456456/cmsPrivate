...
(function (a, b) {
    ...
    $('.bootstrap-switch-mini bootstrap-switch-id-status3 bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-animate bootstrap-switch-off').children().children().eq(1).css('border-right','2px solid rgb(145, 145, 145)')
